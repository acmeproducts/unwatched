...
If you find a vulnerability in Unwatched, please report it privately through GitHub: [Security → Report a vulnerability](https://github.com/kresogalic8/unwatched/security/advisories/new). Do not open a public issue for it.
