...
export default function Account() {
  ...
  return (
    <Page>
      <div className="grid gap-5 grow" style={{ gridTemplateColumns: "260px minmax(0,1fr) minmax(0,1fr)" }}>
        <Card className="text-[15px] font-semibold gap-1"><div className="px-3.5 py-2.5 rounded-2xl bg-glass text-teal font-bold">Your agents</div><div className="px-3.5 py-2.5 text-ink2">Credits and plan</div><div className="px-3.5 py-2.5 text-ink2">Who thinks</div><div className="px-3.5 py-2.5 text-ink2">Letters and notifications</div><div className="px-3.5 py-2.5 text-ink2">Rules of the island</div><button onClick={async () => { await signOut(); r.push("/"); }} className="px-3.5 py-2.5 text-left text-ink2 hover:text-coral">Sign out</button></Card>
