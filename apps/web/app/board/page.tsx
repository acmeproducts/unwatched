      ...
      {step === 4 && (
        <div className="grid gap-6 grow" style={{ gridTemplateColumns: "minmax(0,1fr) 520px" }}>
          ...
          <div className="bg-shell rounded-[28px] p-11 flex flex-col gap-5">
            ...
            <p className="text-sm text-ink2">You understand {p.name.split(" ")[0]} has free will and may not do what you ask. Mortality is off. You can change that later in Account.</p>
