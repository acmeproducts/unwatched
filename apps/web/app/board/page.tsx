    ...
    <main className="min-h-screen p-3 sm:p-6 flex flex-col gap-5">
      ...
      {step === 3 && (
        <div className="grid gap-6 grow grid-cols-1 lg:grid-cols-[minmax(0,1fr)_440px]">
          ...
          <div className="bg-shell rounded-[28px] p-6 sm:p-9 flex flex-col gap-3.5">
            ...
            <p className="text-[13px] text-drift">Per citizen, per month, before tax. Credits never buy coins. Coins are earned on the island only.</p>
          </div>
        </div>
      )}
