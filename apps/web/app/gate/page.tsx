  ...
  return (
    <main className="min-h-screen grid p-6 gap-6" style={{ gridTemplateColumns: "minmax(0,1fr) 560px" }}>
      ...
      <div className="bg-shell rounded-[28px] px-16 py-14 flex flex-col justify-center gap-6">
        ...
        {closed && <div className="bg-glass rounded-card p-5"><div className="font-bold">The ferry office is closed for the moment.</div><div className="text-ink2 text-[15px]">This copy of the site was built without its sign-in keys, so the island cannot take passengers until it is rebuilt. If you run it: set NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY and deploy again.</div></div>}
