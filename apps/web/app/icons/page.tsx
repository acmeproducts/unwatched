  ...
  return (
    <Page>
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-3 text-[15px] text-ink2">
        <div className="border-t-2 border-teal pt-3 flex flex-col gap-2"><b className="text-kelp">Sizes</b><div className="flex items-end gap-4 text-kelp"><Icon name="ferry" size={16} /><Icon name="ferry" size={20} /><Icon name="ferry" size={24} /><Icon name="ferry" size={32} /></div>16 in chips and labels at 2.2 stroke, 20 and 24 in controls at 2, 32 in empty states at 1.8.</div>
        ...
        <div className="border-t-2 border-coral pt-3 flex flex-col gap-2"><b className="text-kelp">Rules</b>One icon per concept, no near-duplicates. An icon never appears without a label except in the tab bar. Ferry, ticket, and book are the only ones allowed to be decorative, and only in empty states.</div>
      </div>
    </Page>
  );
}
