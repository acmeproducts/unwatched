...
export default function People() {
  ...
  return (
    <Page>
      <div className="grid gap-5 grow" style={{ gridTemplateColumns: "420px minmax(0,1fr)" }}>
