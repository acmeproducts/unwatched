...
export function NoAgent({ what }: { what: string }) {
  return <Card className="max-w-[560px]"><Icon name="ferry" size={32} className="text-teal" /><Label>Harbor office</Label><h1 className="text-[28px] font-bold">You have nobody on the island yet.</h1><p className="text-ink2">{what}</p><LinkButton href="/board">Send someone over</LinkButton></Card>;
}
