...
export const WOOD = 0xc4b08c, WOOD_DARK = 0xa3906d, STONE = 0xd9d6cc, STONE_DARK = 0xc4c0b4, GLASS = 0xd6e4e2, DARK = 0x16263a, DRIFT = 0x8e9aa8, MIST = 0xd6e4e2;
...
export const SKY = { night: [0x0a111c, 0x16263a], storm: [0x3f4d5c, 0x6f7d8c], grey: [0x9aa9b0, 0xc7d0d4], dusk: [0xe8a86a, 0xf2d6b0], day: [0xb9dbe6, 0xe4f0f2] } as const;
