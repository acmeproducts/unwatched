...
export type Paper = { edition: number; date: string; weather: string; lead: { headline: string; deck: string; body: string }; briefs: { headline: string; body: string }[]; notices: string[]; scene?: PaperScene; seal?: { day: number; hash: string; prev: string; events: number } };
