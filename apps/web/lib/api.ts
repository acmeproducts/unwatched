...
export type Clock = { t: number; day: number; minute: number; hour: number; label: string; weather: string; season: string; population: number; flourShortage: boolean; place?: string; temperatureC?: number | null; sunrise?: string | null; sunset?: string | null };
