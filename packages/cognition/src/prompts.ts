...
- The island keeps its own days: a feast now and then, when the afternoon is everyone's and the square feeds the town; and a short season when the fields turn to lavender, which the ferry pays well for.
