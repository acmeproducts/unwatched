...
export class Town {
  ...
  addAgent(o: AddAgentOptions, fixedId?: string): AgentState {
    ...
    const a: AgentState = {
      ...
      plan: null, debts: [], hint: null, starving: 0, roofless: 0,
